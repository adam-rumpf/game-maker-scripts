...
* [`_derivative`](https://github.com/adam-rumpf/game-maker-scripts/blob/master/scripts/_derivative/_derivative.gml): Numerically differentiates an array of function values using [finite differences](https://en.wikipedia.org/wiki/Finite_difference).
